...
Тест-кейсы (приватные сценарии): `_private/docs/test-cases/`.
...
**Спека:** [openspec/specs/framework-chains/spec.md](openspec/specs/framework-chains/spec.md) (раздел Open questions)  
