      ...
      <div className="max-w-[1200px] mx-auto px-8 pb-24 flex gap-8 mt-10 framework-detail-layout">
        ...
        <main className="flex-1 min-w-0 space-y-10">
          ...
          <section id="pain" className="scroll-mt-20">
            ...
            {fw.intent && (
              <div className="bg-surface rounded-[8px] p-5 border border-surface-alt">
                <div className="mono text-[10px] text-subtle uppercase tracking-wider mb-2">Цель</div>
                <p className="text-[15px] text-text leading-relaxed">{fw.intent}</p>
              </div>
            )}
          </section>
